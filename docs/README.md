...
1. Создайте ???публичный??? репозиторий с README файлом
...
4. Все коммиты пишутся исключительно на латинице, осмысленными предложениями. Пользуйтесь переводчиком.
### Формат коммитов
...
1. Получив новую работу, необходимо создать новую ветку из mster с латинским названием практической (названия будут указаны на Кириллице и Латинице). 
2. 